...
import { SebmGoogleMapDirection } from './directives/google-map-direction';
import { ScmGoogleWalkingpath } from './directives/google-map-walkingpath';
...
export function coreDirectives() {
  return [
    ...
    SebmGoogleMapPolygon, SebmGoogleMapPolyline, SebmGoogleMapPolylinePoint, ScmGoogleWalkingpath,
    SebmGoogleMapDirection
  ];
};
