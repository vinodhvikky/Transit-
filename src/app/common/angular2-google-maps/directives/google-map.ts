...
@Component({
  ...
  providers: [
    ...
    PolygonManager, WalkingpathManager, DirectionManager
  ],
  inputs: [
...
export class SebmGoogleMap implements OnChanges, OnInit, OnDestroy {
    private static _mapOptionsAttributes: string[] = [
       ...
       */
      private disableDoubleClickZoom: boolean = false;

      /**
       * Enables/disables all default UI of the Google map. Please note: When the map is created, this
       * value cannot get updated.
       */
      private disableDefaultUI: boolean = false;

      /**
       * If false, disables scrollwheel zooming on the map. The scrollwheel is enabled by default.
       */
      private scrollwheel: boolean = true;
       ...
       */
      private draggableCursor: string;
       ...
       */
      private usePanning: boolean = false;
       ...
       */
      private streetViewControl: boolean = true;

      /**
       * Sets the viewport to contain the given bounds.
       */
      private fitBounds: LatLngBoundsLiteral|LatLngBounds = null;

      /**
       * The initial enabled/disabled state of the Scale control. This is disabled by default.
       */
      private scaleControl: boolean = false;

      /**
       * The initial enabled/disabled state of the Map type control.
       */
      private mapTypeControl: boolean = false;
       ...
       */
      private mapClick: EventEmitter<MouseEvent> = new EventEmitter<MouseEvent>();

      /**
       * This event emitter gets emitted when the user right-clicks on the map (but not when they click
       * on a marker or infoWindow).
       */
      private mapRightClick: EventEmitter<MouseEvent> = new EventEmitter<MouseEvent>();

      /**
       * This event emitter gets emitted when the user double-clicks on the map (but not when they click
       * on a marker or infoWindow).
       */
      private mapDblClick: EventEmitter<MouseEvent> = new EventEmitter<MouseEvent>();

      /**
       * This event emitter is fired when the map center changes.
       */
      private centerChange: EventEmitter<LatLngLiteral> = new EventEmitter<LatLngLiteral>();

      /**
       * This event is fired when the viewport bounds have changed.
       */
      private boundsChange: EventEmitter<LatLngBounds> = new EventEmitter<LatLngBounds>();

      /**
       * This event is fired when the map becomes idle after panning or zooming.
       */
      private idle: EventEmitter<void> = new EventEmitter<void>();

      /**
       * This event is fired when the zoom level has changed.
       */
      private zoomChange: EventEmitter<number> = new EventEmitter<number>();
