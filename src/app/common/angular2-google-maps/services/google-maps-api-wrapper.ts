...
export class GoogleMapsAPIWrapper {
    ...
    getRoute (request: mapTypes.DirectionOptions): Observable<any> {
    ...
    setDirectionsMap(direction: any, id: string): any {
        return this.getNativeMap().then((map: mapTypes.GoogleMap) => {
            this._directionsDisplay.setDirections(direction);
            this._directionsDisplay.setMap(map);
            this._directionsDisplay.setPanel(document.getElementById(id));
